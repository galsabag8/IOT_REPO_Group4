...
# ------ listener.py ------
SERIAL_PORT = 'COM6'    # com port to which the wand is connected, update as needed
BAUD_RATE = 921600     
IP = "127.0.0.1"
...
PORT_CMD_IN = 5008      # Commands FROM Arduino (button presses)
PORT_WARMUP = 5009   # Warmup beat triggers
